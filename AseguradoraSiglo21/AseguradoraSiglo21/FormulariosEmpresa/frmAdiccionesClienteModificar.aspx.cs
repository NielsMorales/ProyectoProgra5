...
{
    public partial class frmAdiccionesClienteModificar : System.Web.UI.Page
    {
        ...
        protected void btnModificar_Click1(object sender, EventArgs e)
        {
            ...
            this.modificarAdiccionCliente();

        }

        protected void ddCodigoBurcar_SelectedIndexChanged(object sender, EventArgs e)
        {
            this.cargaCodigoAdiccionBusqueda();
        }

        void cargaCodigoAdiccionBusqueda()
        {


            BLAdicciones_Cliente oAdiccion = new BLAdicciones_Cliente();

            sp_SeleccionaUnaAdiccion_Result adiccion = oAdiccion.RetornaAdicionID(Convert.ToInt16(this.ddCodigoBurcar.SelectedValue));

            this.txtCodigoBuscar.Text = adiccion.Codigo;
