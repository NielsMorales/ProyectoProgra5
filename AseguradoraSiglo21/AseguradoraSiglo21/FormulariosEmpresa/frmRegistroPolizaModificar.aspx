<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterAseguradora.Master" AutoEventWireup="true" CodeBehind="frmRegistroPolizaModificar.aspx.cs" Inherits="AseguradoraSiglo21.FormulariosEmpresa.frmRegistroPolizaModificar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contenidoPrincipal" runat="server">
    ...
    <h1 class="text-center"><strong>Formulario de Modificación de Póliza</strong></h1>
        ...
        <asp:Button ID="btnModificar" runat="server" class="btn btn-primary mb-2" Text="Modificar" OnClick="btnModificar_Click"/>
