<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterAseguradora.Master" AutoEventWireup="true" CodeBehind="frmAdiccionesClienteReporte.aspx.cs" Inherits="AseguradoraSiglo21.FormulariosEmpresa.frmAdiccionesClienteReporte" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contenidoPrincipal" runat="server">
    ...
    <asp:Label ID="Label6" runat="server" style="font-weight: 700" Text="Nombre Adicción: "></asp:Label>

    <asp:TextBox ID="txtNombreAdiccion" runat="server" class="form-control mb-2 mr-sm-2" Width="100px"></asp:TextBox>
    ...
    <rsweb:reportviewer ID="rpvClientesAdicciones" runat="server" Width="100%">
    </rsweb:reportviewer>
